										...
										<tr>
											<td height="25" valign="middle" align="center">
												...
												<table  align="center" cellspacing="0" cellpadding="0" border="0" class="full-width">
													<tbody>
														<tr>
															 <td align="center"><img src="{{url('img/w_logo.jpg')}}"  height="70"/></td>
																		...
																		<td align="center">
																			...
																			<table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="full-width" >
																				<tbody>
                                                                                    ...
                                                                                    <tr>
																						<td><img src="{{ url('img/events/'.$details['image']) }}"  style="width:100%; height:auto" /></td>
																					</tr>
																					<tr>
																					...
																					<tr >
																						<td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="left">
																							กับกิจกรรม {{$details['subject']}} ที่จะเกิดขึ้น</td>
																					</tr>
                                                                                    <tr >
																						<td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#666; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="left">
                                                                                         ในวันที่ {{$details['time']}}</td>
																					</tr>
                                                                                    <tr >
																						<td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#666; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="left">
                                                                                         สถานที่ {{$details['address']}}</td>
																					</tr>
																					<tr>
																								...
																								<tbody>
																									<tr>
																										<td align="center" style="border-radius:3px;color: #1b1717;display:block;font-family: Arial, Helvetica, sans-serif;font-size:12px;line-height:12px;text-align:center;text-decoration:none;padding-top: 10px;padding-bottom: 10px;width:110px;-webkit-text-size-adjust:none;background-color: #ffd430;">
																											<a style="color: #0e0a0a;font-family: Arial, Helvetica, sans-serif;font-size:12px;text-decoration:none !important;" href="{{$details['url']}}">รายละเอียดเพิ่มเติม</a>
																										</td>
																									</tr>
																								</tbody>
																							</table>
																					...
																					<tr>
																					@if($details['qrcode'] != null)
																					<td><img src="{!!$message->embedData(QrCode::format('png')->size(300)->generate($details['qrcode']), 'QrCode.png', 'image/png')!!}"></td>
																					@endif
																					</tr>
                                                                                    <tr>
																						<td height="30">&nbsp;</td>
																...
																<tbody>
																	<tr>
																		<td  align="center" valign="middle" style="font-family: Arial, Helvetica, sans-serif;font-size:11px; font-weight:normal; color:#cccccc; padding-top:10px; padding-bottom:10px">
																			<strong>Copyright © 2020 khunsukto.com</strong><br />
																		</td>
																	</tr>
																</tbody>
															</table>
