	...
	<div class="row icons-container">
		...
		<div class="col-md-4">
			<div class="icon-box-2 with-line">
				<img src="{{ url('img/icon/01.png') }}">
				<h3>วิทยากรบรรยาย</h3>
				<p>ด้านการสร้างแรงบันดาลใจ อุดมการณ์ ความรักชาติ ความจงรักภักดีต่อสถาบันชาติ ศาสนา พระมหากษัตริย์ โดยใช้นวัตกรรมการบรรยายประกอบ แสง สี เสียง และ เพลงในการบรรยาย</p>
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="icon-box-2 with-line">
			<img src="{{ url('img/icon/02.png') }}">
				<h3>วิทยากรกิจกรรม</h3>
				<p>ด้านสันทนาการกลุ่ม การละละพฤติกรรม และการทำงาน
ในรูปแบบกิจกรรมเชิงสร้างสรรค์ แบบเดี่ยวและกลุ่ม
เพื่อเสริมสร้างคุณลักษณะที่ดีแก่ผู้เข้าร่วมกิจกรรม</p>
			</div>
		</div>
		...
		<div class="col-md-4">
			...
			<img src="{{ url('img/icon/03.png') }}">
				<h3>วิทยากรฝึกอบรม </h3>
				<p>การฝึกอบรมเยาวชนและประชาชนทั่วไป ด้านการปลูกฝังระเบียบวินัย , เสริมสร้างความสามัคคี , ความกตัญญู , การเสริมสร้างบุคลิกภาพ และ ปลูกฝังให้เยาวชนมีจิตสำนึก จิตอาสาและจิตสาธารณะ</p>
			</div>
		</div>
		...
		<div class="col-md-6">
			<div class="icon-box-2 with-line">
			<img src="{{ url('img/icon/04.png') }}">
				<h3>วิทยากรการต่อสู้ป้องกันตัว</h3>
				<p>ด้านการต่อสู้ป้องกันตัว ด้วยมือเปล่ากับมือเปล่า เป็นศาสตร์ซึ่งมีมาตั้งแต่บรรพบุรุษ รวมถึงการต่อสู้ด้วย มีด, ไม้, และปืน เป็นผู้เชี่ยวชาญการสอนยิงปืนทั้งเป้านิ่งและรณยุทธ์</p>
			</div>
		</div>
		...
		<div class="col-md-6">
			<div class="icon-box-2">
			<img src="{{ url('img/icon/05.png') }}">
				<h3>วิทยากรการฝึกสอนเทคนิคการนำเสนอ </h3>
				<p>การฝึกสอนการพูดและการเป็นวิทยากรในรูปแบบต่างๆ ด้วยเทคนิคการสื่อสารแบบบูรณาการ การถ่ายทอดอารมณ์ผ่านหัวใจ และเทคนิคการใช้ภาษากายเพื่อเสริมสร้างทักษะพิเศษในการนำเสนอ</p>
			</div>
		</div>

		<div class="col-md-12 text-center">
		<a href="{{ url('contact') }}" class="button button margin-top-15">ติดต่อเป็นวิทยากร</a>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				...
				ความคิดเห็นจากผู้เข้ารับการบรรยาย
					<span class="margin-top-25">ทุกความคิดเห็นมีคุณค่าสำหรับเราในการปรับใช้ เเละพัฒนาการบรรนยายของเราในอนาคต</span>
				</h3>
			</div>
		</div>
...
<section class="fullwidthmargin-top-40 border-top margin-bottom-0 padding-top-60 padding-bottom-65" data-background-color="#ffffff">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12">
				<h3 class="headline centered margin-bottom-40 margin-top-10">หน่วยงานที่เกี่ยวข้อง <span> หน่วยงานเเละองค์กรต่างๆ ที่สนับสนุนและเคยร่วมงานกับเรา</span></h3>
			</div>
