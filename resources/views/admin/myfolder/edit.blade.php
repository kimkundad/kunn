...
<div class="col-md-12">
  <div class="card">
    <div class="card-body">
      <h4 class="card-title">ข้อมูล folder</h4>
      ...
      <form class="forms-sample" method="POST" action="{{$url}}" enctype="multipart/form-data">
        ...
        <label for="exampleInputUsername1">รูป folder<span class="text-danger"></span></label>
          <br />
          <img src="{{ url('img/folder/'.$objs->image) }}" style="width: 450px; border: 2px solid #439aff;" >
          <br />
          <br />
          <label for="exampleInputUsername1">แก้ไขรูป folder <span class="text-danger">*</span></label>
