    ...
    <div class="card-body">
      ...
      <form class="forms-sample" method="POST" action="{{$url}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" placeholder="#March2021 Angular Meetup by CODIUM" name="name" value="{{ old('name') }}">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control"  name="name_address" placeholder="CODIUM , 11 FLOOR" value="{{ old('name_address') }}">
        </div>

        <div class="form-group">
          <label for="exampleInputUsername1">ที่อยู่สถานที่ <span class="text-danger">*</span></label>
          <input type="text" class="form-control"  name="address" placeholder="Siam@Siam Design Hotel Bangkok ชั้น 11 BTS สนามกีฬาแห่งชาติ" value="{{ old('address') }}">
        </div>

        <div class="form-group">
          <label for="exampleInputUsername1">วันที่ <span class="text-danger">*</span></label>
          <input type="text" class="form-control" placeholder="30 Mar 2021"  name="start_event_date" value="{{ old('start_event_date') }}">
        </div>

        <div class="form-group">
          <label for="exampleInputUsername1">ถึงวันที่ <span class="text-danger">(ไม่ใส่ก็ได้ จะแสดงแค่วันที่เริ่ม)</span></label>
          <input type="text" class="form-control" placeholder="30 Mar 2021"  name="end_event_date" value="{{ old('end_event_date') }}">
        </div>

        <div class="form-group">
          <label for="exampleInputUsername1">เวลา <span class="text-danger">*</span></label>
          <input type="text" class="form-control" placeholder="at 18:00 - 22:00" name="start_event_time" value="{{ old('start_event_time') }}">
        </div>
        ...
        <div class="form-group">
                      ...
                      @if(isset($ex))
                      @foreach($ex as $u)
                      <option value="{{$u->id}}" > {{$u->ex_name}} </option>
                      @endforeach
                      @endif
                    </select>
        </div>
        ...
        <div class="form-group">
                      ...
                      <select class="form-control" name="type">
                        ...
                        <option value="0">แบบสมัครสมาชิก</option>
                        <option value="1">แบบไม่สมัครสมาชิก</option>
                      </select>
                    </div>
