    ...
    <div class="card-body">
      ...
      <form class="forms-sample" method="POST" action="{{$url}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputUsername1" name="position" value="{{ $objs->position }}">
        </div>
       

        <div class="form-group">
        <label for="exampleInputUsername1">รูป Review<span class="text-danger"></span></label>
          <br />
          <img src="{{ url('img/review/'.$objs->avatar) }}" style="width: 450px; border: 2px solid #439aff;" >
          <br />
          <br />
          <label for="exampleInputUsername1">แก้ไขรูป Review <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" name="detail" cols="40" rows="10"  spellcheck="true">{{ $objs->detail }}</textarea>
        </div>
